...
func acquireLoop(
	m *multiSemaphore,
	acquireFunc func(s *semaphore.Weighted, n int64) interface{},
	successFunc func(value interface{}) bool,
	n int64,
...
func (m *multiSemaphore) Acquire(ctx context.Context, n int64) error {
	r := acquireLoop(m,
		func(s *semaphore.Weighted, n int64) interface{} {
...
type SemaphorePool struct {
	rw           sync.RWMutex
	semaphoreMap map[string]*semaphore.Weighted
}
