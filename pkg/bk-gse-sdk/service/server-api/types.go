...
type ClusterPluginDispatchMessageResp struct {
	Code         int
	Message      string
	AgentResults map[string]*types.DispatchAgentResult
}

// ClusterPluginRespondMessage describes the body of respond message from agent.
type ClusterPluginRespondMessage struct {
	MessageID string
	AgentID   string
	Content   string
}
